(defproject fundingcircle/jackdaw "0.2.0"
  ...
  :dependencies [[fundingcircle/jackdaw-admin "0.2.0"]
                 [fundingcircle/jackdaw-client "0.2.0"]
                 [fundingcircle/jackdaw-serdes "0.2.0"]
                 [fundingcircle/jackdaw-streams "0.2.0"]
                 [fundingcircle/jackdaw-test "0.2.0"]
